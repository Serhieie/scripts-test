...
const filteredJobsLinc =
  'https://robota.ua/zapros/junior-full-stack-react/ukraine';

//node ./scripts/rabotakUa/parse/parseJuniorFullStack.js
...
(async () => {
  ...
  // fs.writeFile('searchResultJuniorFullStack.json', result, function (err) {
